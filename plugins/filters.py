        ...
        if filenames and links:
            for filename, link, filesize in zip(filenames, links, filesizes):
                btn.append(
                    ...
                    [InlineKeyboardButton(text=f"{filesize}",url="https://t.me/joinchat/SvKwgBUA_RzHoNd6")], 
                ), 
        else:
            return
