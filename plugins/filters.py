...
async def filter(client: Bot, message: Message):
    ...
    if 2 < len(message.text) < 50:    
        ...
        name = message.text
        btn.append(
            [InlineKeyboardButton("🎟️JOIN CHANNEL", url="https://t.me/joinchat/xy2tjwLH-a05Y2Jk")]
            )
        ...
        if len(btn) > 10: 
            ...
            await message.reply_text(
               f"<b> ➠Cʜᴀɴɴᴇʟ : @TAMILROKERS12"
                "/nHere is the result for {message.text}\n" 
                "/n📌 താഴെ കാണുന്ന ജോയിൻ ചാനലിൽ ക്ലിക്ക് ചെയ്‌തതിനു ശേഷം മാത്രം മൂവി ബട്ടണിൽ ക്ലിക്ക് ചെയ്യുക 👇👇👇\n</b>",
        ...
        await message.reply_text(
                f"<b> ➠Cʜᴀɴɴᴇʟ : @TAMILROKERS12"
                "/nHere is the result for {message.text}" 
                "/n📌 താഴെ കാണുന്ന ജോയിൻ ചാനലിൽ ക്ലിക്ക് ചെയ്‌തതിനു ശേഷം മാത്രം മൂവി ബട്ടണിൽ ക്ലിക്ക് ചെയ്യുക 👇👇👇</b>",
                reply_markup=InlineKeyboardMarkup(buttons)
            )    
